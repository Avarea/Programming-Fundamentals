...
namespace ForumTopics
{
    class Program
    {
        static void Main()
        {
            ...
            string[] inputTokens =ParseInputTokens(Console.ReadLine());
        ...
        static void StoreTags(Dictionary<string, HashSet<string>> data,string topic,string[] tags)
        {
        ...
        static void PrintTopicsByFilteredTags(Dictionary<string, HashSet<string>> data,string[] filteredTags)
        {
        ...
        static bool ContainsAllTags(HashSet<string> tags,string[] filteredTags)
        {
